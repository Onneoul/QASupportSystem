...
class macro:
    ...
    def __init__(self, root):
        ...
        self.root = root  # Tkinter root instance
    ...
    def record_mouse_position(self):
        while True:
            ...
            time.sleep(0.1) # 10ms마다 마우스 움직임 저장
    ...
    def stop_recording(self):
        keyboard.unhook_all()
        self.mouse_thread.join()  # Stop the mouse recording thread
    ...
    def save_only(self):
        ...
        file_path = f"./{file_name}"  # Using the current directory for now
